...
#print data1
    data1=data1.dropna()
    df = open("phagemidsequencingProteinout1.txt", "r")
    df = df.read()
    df = df.split('\n')
    del df[-1]
    df = np.array(df)
    ...
    #Using matplotlib
        ...
        #labels = species
        #plt.pie(x=count, autopct="%.1f%%", explode=[0.05]*6, labels=labels, pctdistance=0.5)
        #plt.title("Fram+CDR Graph", fontsize=14);
       # plt.show()
       # print(colored((NameIn),'blue'),colored((Frame1),'red'),colored((VarRegion1),'green'), colored((Frame2),'red'),colored((VarRegion2),'green'),colored((Frame3),'red'), colored((VarRegion3),'green'))
    #    print data1['CDR1']
        nama=data1["Phage ID"]
        ...
        if (name1==''):
            ...
            FNBX=FNB
#        print NBX3
#        print data1['NBX'][NBX1]
#        print NBX1

            if NBX1!='':
                X=1
               # print("The squence", CDRTable[0],"at CDR1 belongs to NBX", data1['NBX'][NBX1], "and sequence",data1['Phage ID'][NBX1]) 
 #           print NBX
         ...
         #   NBX=data1['NBX']
          #  NBX= NBX.iloc[[1, -1]]
           # print NBX
            if NBX2!='':
             #print("The squence", CDRTable[0],"at CDR2 belongs to NBX", data1['NBX'][NBX2], "and sequence",data1['Phage ID'][NBX2]) 
                 Y=1
             #NBX=data1['NBX']
           ...
           # NBX=data1['NBX']
            #NBX= NBX.iloc[[1, -1]]
            if NBX3!='':
            #print("The squence", CDRTable[0]," at CDR3 belongs to NBX", data1['NBX'][NBX3], "and sequence",data1['Phage ID'][NBX3]) 
                Z=1
            #NBX=data1['NBX']
